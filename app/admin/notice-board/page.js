...
const page = () => {
  return (
    <div className="min-h-screen ">
      <AddNotice />
      <NoticeBoard role={"admin"} pageLength={8} />
    </div>
  );
};
...
function AddNotice() {
  ...
  if (isLoading) {
    return (
      <button
        className=" shadow-sm hover:shadow-md flex items-center gap-2 text-base font-semibold p-2 m-2 rounded-md border border-[#ddd] "
